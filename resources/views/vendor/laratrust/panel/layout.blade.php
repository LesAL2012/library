                    ...
                    <div class="flex items-center">
                        <div class="hidden md:block">
                            <div class="flex items-baseline">
                                <a href="{{ route('home') }}" class="nav-button border">← Home</a>
                        ...
                        <div class="ml-10 flex-shrink-0 text-white font-semibold text-xl" style="color: lightskyblue">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="lightskyblue" class="w-10 h-10 inline-block">
